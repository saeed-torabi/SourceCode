...
namespace Board.Web
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var emailFrom = WebConfigurationManager.AppSettings["EmailFrom"].ToString();
            var mailMessage = new MailMessage(emailFrom, message.Destination, message.Subject, message.Body);
